...
/*
const acceptTerms = new Prompt({
  name: 'accept_terms',
  requestable: true,
});
// add to index 0, order goes select_account > login > acceptterms > consent
interactions.add(acceptTerms, 2);
*/
...
module.exports = {
  clients: [
    {
      ...
      redirect_uris: ["http://localhost:3000/login/response"],
      post_logout_redirect_uris: ["http://localhost:3000/logout/response"],
    },
    {
      client_id: "gatsby_app",
      token_endpoint_auth_method: "none",
      client_secret: "abc123",
      grant_types: ["refresh_token", "authorization_code"],
      redirect_uris: ["http://localhost:8000/callback"],
      post_logout_redirect_uris: ["http://localhost:8000/callback"],
      silent_refresh_uris: ["http://localhost:8000/silent_renew"],
    },
    {
      client_id: "graph_server",
  ...
  features: {
    ...
    ietfJWTAccessTokenProfile: { enabled: true }, // defaults to false
